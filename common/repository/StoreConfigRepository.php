...
class StoreConfigRepository extends Repository {
    ...
    public function createConfig($data = array()) {
        ...
        if(isset($data['configName']) && $data['configName']){
            $model->configName = $data['configName'];
        }
        if(isset($data['configImageName']) && $data['configImageName']){
            $model->configImageName = $data['configImageName'];
        }
