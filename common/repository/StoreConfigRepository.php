...
class StoreConfigRepository extends Repository {
    ...
    public function listing($data = array()) {
        ...
        if (!empty($data['store_id'])) {
            $this->checkUserAccess($currentUser, $data['store_id']);
        }
    ...
    public function createRating($data = array()) {
        ...
        $this->checkUserAccess($currentUser, $storeModel['store_id']);
    ...
    protected function checkUserAccess($currentUser,$storeId) {
