 ...
 *
 * Modified by Roy Barkas <roy (at) rbdb.net>
 * modification to allow drag and drop only for defined columns of a table
 * See modified code in build and makeDraggable functions.
 ...
 *     FF3 beta)
 * activeCols
 *    An array.  Each element of the array corresponds to the id of a <td> within each row of the table
 *
...
jQuery.tableDnD = {
    ...
    build: function(options) {
        ...
        this.each(function() {
            ...
            this.tableDnDConfig = {
                // next line new to support selectable td's for dragging
    ...
    makeDraggable: function(table) {
	    ...
	    var nodrag = jQuery(rows[i]).hasClass("noDrag");	    
            // new code down to and including else {            
