									...
									<div class="label-text">
										...
										<span class="slider-input size-label">
											<input type="text" class="form-control" id="ex6SliderVal" name="no_of_shelves" value="<?=  yii::$app->params['shelfConfig']['1']; ?>" required="" max="<?= yii::$app->params['no_of_shelves']['max'] ?>" min="1"/>
                                                                            ...
                                                                            <label for="ex6SliderVal" class="error pull-right" style="font-size: 11px; color: red; right: 10px;"></label>
									</div>
									...
									<div class="label-text">
										...
										<span class="slider-input size-label">																				
											...
											<span class="size-label">cm</span>
                                                                            ...
                                                                            <label for="hex6SliderVal" class="error pull-right" style="font-size: 11px; color: red; right: 10px;"></label>
                                                                        </div>
									<div class="slider-content">
									...
									<div class="label-text">
										...
										<span class="slider-input size-label">
											...
											<span class="size-label">cm</span>
                                                                            ...
                                                                            <label for="wex6SliderVal" class="error pull-right" style="font-size: 11px; color: red;  right: 12px; "></label>
									</div>
									<div class="slider-content">
									...
									<div class="label-text">
										...
										<span class="slider-input size-label">
											...
											<span class="size-label">cm</span>
                                                                            ...
                                                                            <label for="dex6SliderVal" class="error pull-right" style="font-size: 11px; color: red; right: 12px;"></label>
									</div>
									<div class="slider-content">
