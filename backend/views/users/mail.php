...
<tr>
    <td style="font-size: 14px; color: #333333; font-weight: 400; font-family: 'Open Sans', sans-serif; line-height: 20px;">You have successfully registered. You can now <a href="<?= $loginUrl; ?>" style="color: #00a3d4; text-decoration: none;">log in</a> using below username and password.</td>
</tr>
<tr>
    <td height="27">&nbsp;</td>
</tr>
