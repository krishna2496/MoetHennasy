...
<header class="main-header">
    <a href="<?php echo $adminUrl; ?>" class="logo">
      ...
      <span class="logo-lg">
        <img src="<?php echo $adminUrl; ?>images/logo-MH.jpg" alt="Moët Hennessy">
      </span>
    </a>
    <b>
                ...
                <li>
                  <ul class="menu">
                    ...
                    <li>
                      <a href="#">
                        <div class="pull-left">
                          <img src="<?php echo $adminUrl; ?>theme/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                        </div>
                        <h4>
                          Developers
